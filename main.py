...
def simple_convert_with_seo(blog_text, game_data):
    ...
    for line in lines:
        ...
        if 'MLB Betting Preview' in line:
            clean_line = re.sub(r'^<strong>(.+?)</strong>
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port, debug=False), r'\1', line)  # Remove bold wrapper
